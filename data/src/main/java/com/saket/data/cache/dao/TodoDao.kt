...
interface TodoDao {
    ...
    @Query("SELECT * FROM $TODO_ENTRIES") fun getTodo(): Flow<List<TodoEntity>>

    @Insert fun addTodo(todo: TodoEntity)
     ...
     */
    @Query("DELETE FROM todo_entries WHERE id = :todoId") fun removeTodo(todoId: Int): Int
}
