...
/**
 * TodoUseCaseModule in domain/di layer is responsible to provide instance of classes from this
 * layer (AddTodo, GetAllTodos, RemoveTodo etc.).
 *
 ...
 *
 * For ITodoRepository, this module relies on some other module (RoomModule in this case) to provide
 * the instance.
 */
@Module
